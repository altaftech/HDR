                ...
                <div className="popup">
                    <div className="popup-buttons w-full fixed t-0 flex justify-between items-center p-2">
                        ...
                        <div className="popy3 flex gap-6 justify-center items-center">
                            <span onClick={downloadImage} className="btn show2 hover:bg-[rgba(255,255,255,0.1)] rounded-full"><img src="./img/download.svg" alt="download" /></span>
                            <div className="over over2">Download</div>
                            <span className="btn show3 hover:bg-[rgba(255,255,255,0.1)] rounded-full" onClick={closePopup}><img src="./img/close.svg" alt="close" /></span>
                            <div className="over over3">Close</div>
                        </div>
                    </div>
